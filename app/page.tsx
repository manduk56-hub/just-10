    ...
    <main>
      ...
      <section className="game" aria-label="10초 타이밍 게임">
        <div className={`mine-scene ${phase === 'running' ? 'mining' : ''}`}>
          ...
          <div className="scene-bottom"><div className="tool-slot"><img src="/textures/diamond_pickaxe.png" alt="" /><span><strong>다이아몬드 곡괭이</strong><small>DIAMOND PICKAXE</small></span></div><div className="hotbar" role="group" aria-label="마인크래프트 핫바: 2번 다이아몬드 곡괭이 선택됨"><span className="hotbar-slot" title="1번: 다이아몬드 검"><img src="/textures/diamond_sword.png" alt="다이아몬드 검" /></span><span className="hotbar-slot selected" title="2번: 다이아몬드 곡괭이 (선택됨)"><img src="/textures/diamond_pickaxe.png" alt="선택된 다이아몬드 곡괭이" /></span><span className="hotbar-slot" /><span className="hotbar-slot" /><span className="hotbar-slot" /><span className="hotbar-slot" title="6번: 물 양동이"><img src="/textures/water_bucket.png" alt="물 양동이" /></span><span className="hotbar-slot" title="7번: 용암 양동이"><img src="/textures/lava_bucket.png" alt="용암 양동이" /></span><span className="hotbar-slot" /><span className="hotbar-slot" title="9번: 횃불"><img src="/textures/torch.png" alt="횃불" /></span></div><span className="mining-status">{phase === 'running' ? <><span className="live-dot" /> 채굴 중</> : success ? <><Check size={13} /> 채굴 완료</> : <><Crosshair size={13} /> 채굴 준비</>}</span></div>
        </div>
