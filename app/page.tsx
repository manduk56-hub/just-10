...
import { ArrowUpRight, Check, Pickaxe, RotateCcw, Target, Trophy, Volume2, VolumeX } from 'lucide-react';
    ...
    <main>
      ...
      <section className="game" aria-label="10초 타이밍 게임">
        ...
        <div className="timer-panel">
          <div className="timer-top"><span className="timing-tolerance">성공 범위 <strong>±0.100초</strong></span><span className={`status-pill ${phase}`}>{phase === 'ready' ? '준비 완료' : phase === 'running' ? '집중해 주세요' : '도전 완료'}</span></div>
