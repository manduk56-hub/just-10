    ...
    <main>
      <section className="game" aria-label="10초 타이밍 게임">
        ...
        <div className="timer-panel">
          <div className="timer-top"><span className="timing-tolerance">성공 범위 <strong>±0.100초</strong></span></div>
