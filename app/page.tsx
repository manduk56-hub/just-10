    ...
    <main>
      ...
      <section className="game" aria-label="10초 타이밍 게임">
        <div className={`mine-scene ${phase === 'running' ? 'mining' : ''}`}>
          ...
          <div className="scene-bottom"><div className="tool-slot"><img src="/textures/diamond_pickaxe.png" alt="" /><span><strong>다이아몬드 곡괭이</strong><small>DIAMOND PICKAXE</small></span></div><div className="hotbar" aria-label="마인크래프트 핫바"><span className="hotbar-slot" /><span className="hotbar-slot" /><span className="hotbar-slot" /><span className="hotbar-slot" /><span className="hotbar-slot selected"><img src="/textures/diamond_pickaxe.png" alt="다이아몬드 곡괭이" /></span><span className="hotbar-slot"><img src="/textures/water_bucket.png" alt="물 양동이" /></span><span className="hotbar-slot"><img src="/textures/lava_bucket.png" alt="용암 양동이" /></span><span className="hotbar-slot" /><span className="hotbar-slot" /></div><span className="mining-status">{phase === 'running' ? <><span className="live-dot" /> 채굴 중</> : success ? <><Check size={13} /> 채굴 완료</> : <><Crosshair size={13} /> 채굴 준비</>}</span></div>
        </div>
